 ...
 * checked by the API, the customer has the duty to check the condition. Default
 * = 100 ms
 */
 ...
 * Second).\n This is the number of photons reflected back from the cover glass
 * in cps.
 */
 ...
 * there is no check in this function. if the ROI center vs ROI size is out of
 * border the ranging function return error #13
 */
 ...
 * changed by more than 8 deg C without sensor ranging activity for an extended
 * period.
 */
